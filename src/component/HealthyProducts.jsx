...
function HealthyProducts(props) {
  return (
    <div className='mt-10'>
        <Container>
            <div className='shadow-2xl rounded-2xl bg-white p-4'>
                ...
                <p className='mt-5 text-sm md:text-md text-gray-700 leading-relaxed whitespace-pre-line'>{props.description1}</p>
                <p className='mt-5 text-sm md:text-md text-gray-700 leading-relaxed whitespace-pre-line'>{props.description2}</p>
                {
                    props.description3 && (
                        <>
